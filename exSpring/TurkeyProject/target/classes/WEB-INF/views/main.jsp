					...
					<div class="stu_main_b_notice">
						...
						<div class="adm_main_b_notice_title">
							<c:forEach var="main_notice" items="${notice_board_list}">
								* <a href="/Turkey/notice_view?search=1&key=1&idx=${main_notice.idx}&page=1">${main_notice.title}</a>
						...
						<div class="stu_main_b_board">
							...
							<div class="adm_main_b_board_title">
								<c:forEach var="main_free" items="${free_board_list}">	
									* <a href="/Turkey/board_view?search=1&key=1&idx=${main_free.idx}&page=1">${main_free.title}</a>
...
<script>
	function list_mail() {
		window.open("list_mail", "list_mail_form", "width=510 height=540");
	}
</script>
