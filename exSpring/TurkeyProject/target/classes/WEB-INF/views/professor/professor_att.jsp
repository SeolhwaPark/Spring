...
<div class="all">
	...
	<div class="contents">
			...
			<table>
				<tr align="center">
					<th colspan="18">${sub.year}년${sub.semester}학기/${sub.major_code}-${sub.sub_code}/${sub.sub_name}/${day }/Y=출석,N=결석</th>
				</tr>
				<tr>
					<th>학번</th>
					<th>이름</th>
