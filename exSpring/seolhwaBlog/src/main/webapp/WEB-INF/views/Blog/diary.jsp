...
<body>
	...
	<section class="intro">
		<center>
			<div>
				<div class="row">
						...
						<div class="di">
							<p>
								<a href="../Blog/diary">Diary</a>&nbsp;&nbsp;&nbsp;&nbsp; <a
									href="../Blog/photos">Photos&Illustrations</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="../Blog/favoritesongs">Favorite Songs</a>
							</p>
				...
				<div class="container about">
					<div class="row">
						<div class="col-md-6">
							...
							<span>No.</span>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
								class=""> <i class="fa fa-eye"></i> readcnt
		...
		<div class="bottom">
			<input type="button" value="작성" class="btn" onClick="write()">&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
	</section>
	<center>
		<div class="search">
