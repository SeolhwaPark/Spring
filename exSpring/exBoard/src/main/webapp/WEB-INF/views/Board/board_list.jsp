				...
				<table border="0" cellspacing="1" width="100%" align="center">
					...
					<tr>
						<td colspan="5" align="right" valign="middle" height="20"><font
							size="2" face="고딕">전체 : <b>${totcount}</b>건 - ${totpage}/
								${page} Pages
						</font></td>
					</tr>
					<tr bgcolor="e3e9ff">
					...
					<c:if test="${empty list}">
						<tr onMouseOver="style.backgroundColor='#D1EEEE'"
							...
							<td align="center" height="25">등록된 자료가 없습니다</td>
						</tr>
					</c:if>
						...
						<tr onMouseOver="style.backgroundColor='#D1EEEE'"
							...
							<td align="left" height="20">&nbsp; <font face="돋움" size="2"
								color="#000000"> <a class="list"
									href="board_hits?idx=${board.idx}&page=${page}">${board.subject}</a></td>
						...
						<table width="600">
							<tr>
								...
								<td width="50%" align="center">
									<table>
										<form name="guest" method="post" action="board_list">
